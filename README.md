...
[3]: https://godoc.org/github.com/nbldyyhh/nano?status.svg
[4]: https://godoc.org/github.com/nbldyyhh/nano
[5]: https://goreportcard.com/badge/github.com/nbldyyhh/nano
[6]: https://goreportcard.com/report/github.com/nbldyyhh/nano
...
- English
    ...
    + [API Reference(Server)](https://godoc.org/github.com/nbldyyhh/nano)
...
- 简体中文
    ...
    + [API参考(服务器)](https://godoc.org/github.com/nbldyyhh/nano)
    + [如何将`lua`脚本集成到`nano`组件中(未完成)](.)

## Resources

- Javascript
  + [nano-websocket-client](https://github.com/nbldyyhh/nano-websocket-client)
  + [nano-egret-client](https://github.com/nbldyyhh/nano-egret-client)
...
```shell
go get github.com/nbldyyhh/nano
...
cd $GOPATH/src/github.com/nbldyyhh/nano/benchmark/io
