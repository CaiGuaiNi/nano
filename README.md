...
[3]: https://godoc.org/github.com/CaiGuaiNi/nano?status.svg
[4]: https://godoc.org/github.com/CaiGuaiNi/nano
[5]: https://goreportcard.com/badge/github.com/CaiGuaiNi/nano
[6]: https://goreportcard.com/report/github.com/CaiGuaiNi/nano
...
- English
    ...
    + [API Reference(Server)](https://godoc.org/github.com/CaiGuaiNi/nano)
...
- 简体中文
    ...
    + [API参考(服务器)](https://godoc.org/github.com/CaiGuaiNi/nano)
    + [如何将`lua`脚本集成到`nano`组件中(未完成)](.)

## Resources

- Javascript
  + [nano-websocket-client](https://github.com/CaiGuaiNi/nano-websocket-client)
  + [nano-egret-client](https://github.com/CaiGuaiNi/nano-egret-client)
...
```shell
go get github.com/CaiGuaiNi/nano
...
cd $GOPATH/src/github.com/CaiGuaiNi/nano/benchmark/io
